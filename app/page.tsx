              ...
              <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-card p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-teal-100 dark:bg-teal-900">
                  ...
                  >
                    ...
                    <path d="M7.29 12.707a1 1 0 0 1 0-1.414l4-4a1 1 0 0 1 1.414 0l4 4a1 1 0 0 1-1.414 1.414L12 9.414l-3.293 3.293a1 1 0 0 1-1.414 0z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold">Join Our Community</h3>
                <p className="text-muted-foreground">
                  Connect with like-minded individuals committed to ocean conservation and sustainable practices.
                </p>
              </div>
            </div>
          </div>
